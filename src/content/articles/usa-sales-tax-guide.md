...
keywords: "sales tax calculator, sales tax by state, sales tax rate, sales tax nexus, sales tax exemption, e-commerce sales tax, sales tax compliance, sales tax calculator usa, state sales tax"
...
<script type="application/ld+json">
{
  ...
  "@type": "Article",
  "headline": "Sales Tax Calculator: USA States & Cities",
  "description": "Calculate sales tax by state and city instantly. Includes nexus rules, exemptions, compliance strategies & real e-commerce sales tax examples for 2026.",
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sales Tax = Item Price × (Local Sales Tax Rate ÷ 100). Example: $100 item in a location with 8.875% sales tax = $100 × 0.08875 = $8.88 in tax, total $108.88. However, some items are tax-exempt (groceries, medicine, clothing in certain states), and some locations have multiple tax rates. Always verify the specific category and location."
      }
    },
    {
      "@type": "Question",
      "name": "What is sales tax nexus and why does it matter?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sales tax nexus is a legal connection between a business and a state that requires the business to collect and remit sales tax. After the Wayfair ruling (2018), online retailers must collect sales tax in states where they have significant sales activity — even without physical presence. Failing to collect when you have nexus creates liability. Most e-commerce platforms now auto-calculate based on nexus status."
      }
    },
    {
      "@type": "Question",
      "name": "Which items are typically sales tax exempt?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Common exemptions: unprepared food/groceries, medications, medical devices, educational materials, and non-commercial organizations' purchases. Some states exempt clothing or utilities. However, exemptions vary significantly by state. An item that is tax-exempt in California may be taxable in Texas. Always verify your specific state and item category."
      }
    },
    {
      "@type": "Question",
      "name": "How do I know what sales tax rate applies?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sales tax rates are determined by the destination address — where the buyer receives the item. Not where the business is located. You need to know: state rate (0–7.5%), county rate (if applicable), and city/district rate (if applicable). These stack on top of each other. Example: California state (7.25%) + Los Angeles County (9.5%) = 16.75%. Use our calculator or TaxJar's rate lookup for precision."
      }
    },
    {
      "@type": "Question",
      "name": "What happens if I charge wrong sales tax?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Under-collecting creates state liability — the state can audit you and demand back taxes plus penalties. Over-collecting creates customer refund liability — customers can demand refunds for excess tax collected. Over-collection is less serious but still problematic for cash flow. The solution: use software that auto-calculates based on the destination address for every transaction."
      }
    }
  ]
}
...
<link rel="canonical" href="https://quickfincalc.com/articles/usa-sales-tax-guide">
...
✅ **Destination-Based:** Sales tax is calculated where the buyer *receives* the item, not where the business is located
✅ **Multi-Layer:** State + County + City rates stack — some locations have 10%+ total rates
✅ **Nexus Matters:** Post-Wayfair, you must collect even with no physical presence in many states
✅ **Exemptions Vary:** By state AND by item category — no universal rules
✅ **Compliance Automated:** Use software that calculates based on destination address automatically
...
> **Skip Manual Calculations:** Use our **[Sales Tax Calculator](/calculator/sales-tax-calculator)** to get the exact rate for any state and city combination instantly.

👉 **[Calculate Sales Tax Instantly — QuickFinCalc](/calculator/sales-tax-calculator)**

---

## USA Sales Tax by State: Complete 2026 Rates
...
**Sales Tax Collected:** $50,000 × 8.875% = $4,437.50
**Monthly Remittance:** $4,437.50 to New York
...
Sales Tax = Item Price × (Tax Rate ÷ 100). Tax rate is determined by the customer's delivery address, not the seller's location. Some items are exempt (varies by state), and some locations have multiple stacked rates (state + county + city).

**Q: What is sales tax nexus?**
A legal connection between a business and a state that requires collection and remittance of sales tax. Post-Wayfair (2018), you must collect if you exceed the state's sales threshold — even without physical presence.

**Q: Which items are tax exempt?**
Common exemptions: unprepared groceries, medications, medical devices, educational materials. However, exemptions vary dramatically by state. Clothing is exempt in some states and taxable in others. Always verify your specific state and item category.

**Q: How do I know if I have sales tax nexus?**
You have nexus if you exceed the state's threshold. Most states use $100,000–$500,000 annual sales. Some use transaction count (200+ transactions). Track sales by state monthly and cross-reference your state's specific thresholds.

**Q: What happens if I charge the wrong sales tax?**
Under-collecting creates state liability for back taxes plus penalties and interest. Over-collecting creates customer refund liability. Significant discrepancies trigger audits. Solution: use software that auto-calculates based on destination address.

**Q: How often do I file sales tax returns?**
Most states require monthly filing. Some allow quarterly (if low volume). Some require annual. Check your specific state. File on time even if you owe $0.

---

## Free Tools: Calculate Sales Tax Instantly

### 🎯 **[Sales Tax Calculator](/calculator/sales-tax-calculator)**
Get the exact sales tax rate for any state, county, and city combination instantly.

### 🎯 **[Profit Margin Calculator](/calculator/profit-margin-calculator)**
Model how sales tax affects your actual profit margin.

### 🎯 **[Break-Even Calculator](/calculator/break-even-sales)**
Calculate how sales tax impacts your break-even revenue target.

### 🎯 **[E-commerce Profit Margin Calculator](/calculator/shopify-margin-calculator)**
...
1. ✅ **Automate** — Use software that calculates based on destination address
2. ✅ **Track nexus** — Know which states owe you collection obligations
3. ✅ **Register promptly** — File the moment you exceed a threshold
4. ✅ **File on time** — Every month, even if $0
5. ✅ **Reconcile monthly** — Catch errors before they compound
6. ✅ **Keep records** — Document everything for 3+ years
...
👉 **[Calculate Your Sales Tax Instantly — QuickFinCalc](/calculator/sales-tax-calculator)**

**Related Business Tools:**
- [Profit Margin Calculator: E-commerce Edition](/calculator/shopify-margin-calculator)
- [Break-Even Sales Calculator: Know Your Minimum](/calculator/break-even-sales)
- [Business Financial Analysis Complete](/calculator/profit-margin-calculator)
